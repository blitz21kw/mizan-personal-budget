...
export default function TransactionsView({ monthKey, categories, expenses, onEdit, onDelete }: TransactionsViewProps) {
  ...
  return (
    <div className="transactions-view space-y-6 pb-2">
      ...
      <section className="transactions-list-card surface-card overflow-hidden rounded-[28px]">
